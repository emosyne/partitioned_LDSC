...
statsfile_only_within_functfile = statsfile %>% left_join(functfile, by = c("SNP" = "SNP"))

data.table::fwrite(d, "../private_input_files/GWAS/PGC3_SCZ_wave3.european.autosome.public.v3_overInfo.8_LDpredFunct.txt", sep = " ", col.names = T)
