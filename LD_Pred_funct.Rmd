...
#generate pheno file:
join <(sort /rds/general/user/eosimo/home/lenhard_prs/biobank/imputed_chromosomes/LDpredfunct_ukb22828_c22_b0_v3.fam) <(sort results/LDpredfunct_out/SCZ_ldpredfunct.pheno) | awk '{ print $1, $2, $3, $4, $5, $7 }' > results/LDpredfunct_out/SCZ_ldpredfunct.pheno.fam
